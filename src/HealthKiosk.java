...
public class HealthKiosk {
    public static void main(String[] args) {
        ...
        if (shortID.length() == 5 && Character.isLetter(shortID.charAt(0)) && (ID.charAt(0)) == (shortID.charAt(0))) {
        ...
        switch (serviceCode) {
            case 'P':
                System.out.println("Summary: PHARMACY | ID:" + ID + "| Code = " + shiftedLetter + lastTwoChars  );
                break;
            case 'L':
                System.out.println("Summary: LAB | ID: " + ID + "| Code = " + shiftedLetter + lastTwoChars );
                break;
            case 'T':
                if (healthMetric == 1) {
                    System.out.println("Summary: TRIAGE | ID:" + ID + "| Code = " + shiftedLetter + lastTwoChars + "-" + (int)BMI);
                } else if (healthMetric == 2) {
                    System.out.println("Summary: TRIAGE | ID:" + ID + "| Code = " + shiftedLetter + lastTwoChars + "-" + numOfTablets);
                } else {
                    System.out.println("Summary: TRIAGE | ID:" + ID + "| Code = " + shiftedLetter + lastTwoChars + "-" + (int) (sinOfAngle * 100));
                }
                break;
            case 'C':
                System.out.println("Summary: COUNSELLING | ID:" + ID + "| Code = " + shiftedLetter + lastTwoChars );
                break;
